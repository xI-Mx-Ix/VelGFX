...
public class VxMaterial {
     ...
     */
    public static final ResourceLocation DEFAULT_NORMAL = ResourceLocation.tryBuild(VelGFX.MODID, "renderer/blue.png");

    /**
     * A default resource location pointing to a simple black texture.
     */
    public static final ResourceLocation DEFAULT_BLACK = ResourceLocation.tryBuild(VelGFX.MODID, "renderer/black.png");
